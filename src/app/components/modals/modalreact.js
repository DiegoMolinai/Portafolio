  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <p>
          La aplicación permite a los usuarios realizar operaciones CRUD (Crear,
          Leer, Actualizar, Eliminar) en distintos aspectos:
        </p>
        <ul>
        ...
        <p>
          Se implemento un sistema el cual despliega automáticamente
          una notificación en una pantalla visible para los trabajadores del
          taller, mostrando detalles sobre el servicio solicitado y las acciones
          que deben tomar. Esto facilita la organización y asignación de tareas
          cuando un vehículo llega para ser atendido.
        </p>
        <img
